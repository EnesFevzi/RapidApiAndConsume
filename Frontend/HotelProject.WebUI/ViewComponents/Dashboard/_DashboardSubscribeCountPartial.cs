    ...
    public class _DashboardSubscribeCountPartial : ViewComponent
    {
        public async Task<IViewComponentResult> InvokeAsync()
        {
            ...
            var request = new HttpRequestMessage
            {
                ...
                RequestUri = new Uri("https://instagram-profile1.p.rapidapi.com/getprofileinfo/faviacomtr"),
                Headers =
    {
        ...
        { "X-RapidAPI-Host", "instagram-profile1.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://twitter32.p.rapidapi.com/getProfile?username=faviacomtr"),
                Headers =
    {
        { "X-RapidAPI-Key", "b0e517df75mshe55939e89044bccp1fe70cjsn9b4a53e12458" },
        { "X-RapidAPI-Host", "twitter32.p.rapidapi.com" },
            ...
            {
                Method = HttpMethod.Get,
                RequestUri = new Uri("https://fresh-linkedin-profile-data.p.rapidapi.com/get-linkedin-profile?linkedin_url=https%3A%2F%2Fwww.linkedin.com%2Fin%2Fenes-fevzi-%25C3%25A7i%25C3%25A7ekli%2F"),
                Headers =
    {
        { "X-RapidAPI-Key", "b0e517df75mshe55939e89044bccp1fe70cjsn9b4a53e12458" },
